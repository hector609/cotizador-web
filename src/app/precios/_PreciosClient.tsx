...
function PlanCard({
  ...
  return (
    ...
    >
      ...
      {isFeatured && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 shadow-[0_4px_20px_rgba(45,212,191,0.5)]">
          <Badge variant="primary" size="sm" className="bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-500 text-white border-0">
            Más popular
          </Badge>
        </div>
      )}

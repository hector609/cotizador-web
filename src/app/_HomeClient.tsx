...
import { type ChartStat } from "@/components/landing/LandingChart";

const LandingChart = dynamic(
  () => import("@/components/landing/LandingChart").then(mod => mod.LandingChart),
  {
    ssr: false,
    loading: () => <div className="h-64 animate-pulse rounded-xl bg-slate-800/40" />,
  }
);

/* ---------------------------------------------------------------------- */
/* LUMINA Light Premium — framer-motion + NumberFlow                       */
